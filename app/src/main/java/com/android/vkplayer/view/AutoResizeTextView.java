package com.android.vkplayer.view;
        ...
        mSizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSPace) {
                ...
                if (singleline) {
                    ...
                    final StaticLayout layout = new StaticLayout(text, paint, mWidthLimit, Layout.Alignment.ALIGN_NORMAL, mSpacingMult, mSpacingAdd, true);
